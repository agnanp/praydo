<script lang="ts">
    ...
    function handleInputIshaChange(e: Event) {
        ...
        if (calculationSettings.state.ishaMode === "minutes") {
            ...
            calculationSettings.state.isha = String(target.value).replace(
                /\D/g,
                "",
            );
        }
            ...
            {#snippet content()}
                <Tabs.Panel value="location">
                    <div class="px-4">
                        ...
                        {#if selectedLocation.state.label}
                            <div
                                class="mt-4 p-3 bg-surface-500 rounded dark:bg-surface-800"
                            >
                                <p class="font-medium">Selected Location:</p>
                                <p>{selectedLocation.state.label}</p>
                                <p
                                    class="text-sm text-surface-700 dark:text-surface-600"
                                >
                                    Coordinates: {selectedLocation.state
                                        .latitude}, {selectedLocation.state
                                        .longitude}
                                </p>
                            </div>
                        {/if}
                        ...
                        <div
                            class="p-1 rounded text-sm text-surface-800 text-right"
                        >
                    ...
                    <form class="w-full space-y-4 px-4">
                        ...
                        {#if calculationSettings.state.method === "custom"}
                            <label class="label">
                                ...
                                <div class="input-group grid-cols-[1fr_auto]">
                                    <input
                                        type="number"
                                        bind:value={
                                            calculationSettings.state.fajrAngle
                                        }
                                        class="ig-input"
                            ...
                            <label class="label">
                                ...
                                <div class="input-group grid-cols-[1fr_auto]">
                                    ...
                                    <select
                                        class="ig-select preset-tonal-tertiary"
                                        bind:value={
                                            calculationSettings.state.ishaMode
                                        }
                                    >
                                        <option value="degrees">degrees</option>
                                        <option value="minutes">minutes</option>
                            ...
                            <label class="label">
                                ...
                                <select
                                    bind:value={
                                        calculationSettings.state.midnight
                                    }
                                    class="select"
                                >
                        ...
                        <label class="label">
                            ...
                            <div class="input-group grid-cols-[1fr_auto]">
                                <input
                                    ...
                                    type="number"
                                    value={String(
                                        calculationSettings.state.dhuhrMinutes,
                                    ).replace(/\D/g, "")}
                        ...
                        <label class="label">
                            <span class="label-text"
                                >Higher Latitudes Adjustment</span
                            >
                            <select
                                bind:value={
                                    calculationSettings.state.highLatitudes
                                }
                                class="select"
                            >
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-8">
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedTimes.state.daily.fajr
                                    }
                                />
                                <p>Fajr</p>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedTimes.state.daily.sunrise
                                    }
                                />
                                <p>Sunrise</p>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedTimes.state.daily.dhuhr
                                    }
                                />
                                <p>Dhuhr</p>
                            </label>
                            ...
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedTimes.state.daily.maghrib
                                    }
                                />
                                <p>Maghrib</p>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedTimes.state.daily.isha
                                    }
                                />
                                <p>Isha</p>
                            </label>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-8">
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedAlert.state.alert.fajr
                                    }
                                />
                                <p>Fajr</p>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedAlert.state.alert.dhuhr
                                    }
                                />
                                <p>Dhuhr</p>
                            </label>
                            ...
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedAlert.state.alert.maghrib
                                    }
                                />
                                <p>Maghrib</p>
                            </label>
                            <label class="flex items-center space-x-2">
                                <input
                                    ...
                                    type="checkbox"
                                    bind:checked={
                                        selectedAlert.state.alert.isha
                                    }
                                />
                                <p>Isha</p>
                            </label>
                ...
                <Tabs.Panel value="alert">
                    <label class="label px-4">
                        <span class="label-text"
                            >Notification before prayer time</span
                        >
                        <select
                            bind:value={timeRemaining.state.minutes}
                            class="select"
                        >
